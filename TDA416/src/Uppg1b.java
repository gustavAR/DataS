...
public class Uppg1b {
	...
	/**
	 * Adds the parameter element to the sequence after p
	 * @param element String to add to the list
	 */
	public void addAfterP(String element) {
		...
		for (int i = this.size; i > this.position; i--) {
			this.sequence[i] = this.sequence[i - 1];
		}
	...
	/**
	 * Moves the position val steps forward
	 * @param val Steps to move forward
	 */
	...
	public boolean hasNext() {
		return this.position >= 0 && this.position < this.size;
	}
